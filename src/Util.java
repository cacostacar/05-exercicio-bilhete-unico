...
public class Util {
    ...
    private void listarBilhetes() {
        ...
        String aux = "";
        for(int i = 0; i < index; i++) {//puxar do index
            aux += "Número do bilhete: " + bilhete[i].numero + "\n";
            aux += "Nome do usúario: " + bilhete[i].usuario.nome + "\n";
    ...
    //método para exibir o menu do usúario do bilhete
    ...
    // método para carregar o bilhete com um valor informado pelo usúario
    ...
    // método para consultar o saldo de um bihlete --> usúario informa o cpf
    ...
    // método para pesquisar um bilhete pelo cpf do usúario
